...
export default function SpecialMessage({ onComplete }) {
  ...
  const fullMessage = `My Dearest Anju,

Anjali Aapki khushi ke liye mene sab kuchh krna chaha pr socha uske opposite ho gya and aap preshan ho gyi. When I saw you first time, you walked into my world like a beautiful dream.I want to make you smile, forever holding your hand, forever being the reason you believe in love.

Please Forgive me Anjali for everything.
